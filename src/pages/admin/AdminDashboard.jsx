            ...
            <div className="px-5">
                ...
                <div className="mid mb-5">
                    ...
                    <div className=" bg-pink-50 py-5 rounded-xl border border-pink-100">
                        ...
                        {/* text  */}
                        <div className="">
                            <h1 className=" text-center text-lg text-pink-500"><span className=" font-bold">Name :</span> Dashbaord Admin</h1>
                            <h1 className=" text-center text-lg text-pink-500"><span className=" font-bold">Email :</span> admin@gmail.com</h1>
                        </div>
                    </div>
                </div>
