            ...
            <div className=" container mx-auto px-4 py-5 lg:py-8">
                ...
                <div className="top ">
                    ...
                    <div className=" bg-pink-50 py-5 rounded-xl border border-pink-100">
                        ...
                        {/* text  */}
                        <div className="">
                            <h1 className=" text-center text-lg"><span className=" font-bold">Name :</span> Anjali Dhanraj Raut</h1>
                            <h1 className=" text-center text-lg"><span className=" font-bold">Email :</span> anjalidraut.2609@gmail.com</h1>
                        </div>
                    </div>
                </div>
